...
begin
	...
	using Orthography
	using CitableText, CitableBase, CitableCorpus
	using Unicode
...
function conssearch(str, xcriptdict, psgdict; searchmode = :substring)
	...
	for conskey in keysv
		fullkey = xcriptdict[conskey]
			if haskey(psgdict, fullkey)
				results[fullkey] = psgdict[fullkey]
			else
				@info("no key $(fullkey) found in dict.")
			end
...
url = "https://raw.githubusercontent.com/neelsmith/BiblicalHebrew.jl/main/data/tanach.cex"
...
tknidx = corpusindex(corpus, HebrewOrthography())
...
formatmenu = [:fullucode => "Fully pointed Unicode Hebrew",
	:consonantucode => "Unicode Hebrew - consonantal values only",
	:xcript => "Transcription"
]
...
manifest_format = "2.0"
project_hash = "4a4ae9314897239667e810b91948afaa47f8e423"
...
git-tree-sha1 = "eda764973393dea4a6f5b70e218b010e8286718f"
