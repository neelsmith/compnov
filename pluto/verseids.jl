...
# ╔═╡ 09f47588-e229-43e5-87ef-cc48e5a36615
begin
...
# ╔═╡ d6b442ce-c379-4870-81a9-9ae2b4af1a19
md"""*Notebook version:* **1.0.0**"""

# ╔═╡ 6295f33e-cfe0-11ee-3091-17d1623909dc
md"""# Display chapter with verses IDed"""

# ╔═╡ 811b57b8-b679-4501-9a97-1db12ce7ae94
md"""*Retreive source from internet?* $(@bind useremote CheckBox())"""
...
# ╔═╡ 10e8e2d8-e2f2-4fb0-8d69-017f9bfedbc1
versions = [
	"masoretic" => "Hebrew Bible",
	"vulgate" => "Latin Vulgate",
	"septuagint" => "Greek Septuagint",
	"onkelos" => "Aramaic Targum"
]

# ╔═╡ 2ca85c4b-8adc-4dc6-a9bc-fbd02e165590
...
# ╔═╡ eaca16c2-d8f5-443b-a982-3358abf94b88
"""Format a vector of passages for markdown display."""
function formatchapter(chappsgs)
	mdlines = map(chappsgs) do psg
		ref = string("**", passagecomponent(psg.urn), "** ")
		string(ref, psg.text,"\n\n")
	end
	join(mdlines, "\n")
end

# ╔═╡ f12fecd5-323c-4fd6-b851-3f8335c60835
md"""> Load data"""

# ╔═╡ 9e3b4f2e-7563-473e-bcdf-169d8d861130
fsrc = joinpath(pwd() |> dirname, "corpus", "compnov.cex") 

# ╔═╡ c464b808-4958-4444-8edf-e4bdc22df7d3
usrc = "https://github.com/neelsmith/compnov/raw/main/corpus/compnov.cex"

# ╔═╡ 587c5501-4ef3-4d7f-9e29-eafba574ed5f
c = useremote ? fromcex(usrc, CitableTextCorpus, UrlReader) :  fromcex(fsrc, CitableTextCorpus, FileReader) 

# ╔═╡ 6d0a0fb9-6192-4d31-9f7c-63bf49770e19
masoretic = filter(psg -> versionid(psg.urn) == "masoretic", c.passages)

# ╔═╡ cd55770d-b93b-4c15-ba9d-2f137e9a9dc7
vulgate = filter(psg -> versionid(psg.urn) == "vulgate", c.passages)

# ╔═╡ cb6054f6-cf0e-4409-a99a-785027d44854
books = map(vulgate) do psg
	workid(psg.urn)
end |> unique

# ╔═╡ d8ff1d8a-537f-4a26-a93c-db9dc5478c69
md"""*Book*: $(@bind bk Select(map(b -> titlecase(b), books))) *Version*: $(@bind textversion Select(versions, default="vulgate"))"""
...
formatchapter(psg) |> Markdown.parse

# ╔═╡ 895a2d58-b272-40bc-b3b0-62914aa55d89
septuagint = filter(psg -> versionid(psg.urn) == "septuagint", c.passages)

# ╔═╡ eb852e2e-2306-4549-b761-cbec7b40b852
onkelos = filter(psg -> versionid(psg.urn) == "onkelos", c.passages)
...
manifest_format = "2.0"
project_hash = "4fc27275a62fa367db6ae95330cf0ace750ea368"
