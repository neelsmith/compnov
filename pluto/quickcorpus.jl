...
# ╔═╡ 06e5930a-e5c0-48f0-a49e-a50ab7e5aece
TableOfContents()

# ╔═╡ 79b555a7-2949-4e67-9dcc-1916acb8f3d3
md"""> *Q&D: generalize this to accept a corpus from any place:*"""
...
# ╔═╡ 24222131-21cc-42f9-8a6f-eb9d12bd8042
vulgate = filter(p -> versionid(p.urn) == "vulgate", corpus.passages) |> CitableTextCorpus

# ╔═╡ 19494c32-db19-11ef-26f5-534aa91b3224
md"""# Overview of a parseable Latin corpus: Vulgate"""

# ╔═╡ 19f3a042-0629-4ebf-b37a-54dce7801681
md"""## Vocabulary coverage"""

# ╔═╡ ea78b216-7483-441a-a2e5-12efe46448b4
md"""### Coverage by most number of vocabulary items"""

# ╔═╡ 60b6c2fa-d45f-4635-a687-8d3a4f17f3a6
md"""### See coverage of most frequent words"""

# ╔═╡ 80b86e72-9451-4769-8550-246bfb88a11e
md"""
See top `n` terms where `n` =  
$(@bind n Slider(5:400; show_value=true))
"""
...
# ╔═╡ a6bed1df-1108-4593-994f-0b851eaac2d6
tkns = tokenize(vulgate, latin24())

# ╔═╡ 987a29c5-1e26-4f82-b96f-96bc232228b0
lex = filter(t -> t.tokentype isa LexicalToken, tkns)

# ╔═╡ 75480851-5b3c-404d-be76-006ad8ecf8e1
totallex = length(lex)

# ╔═╡ 2d039207-ed71-4d29-9be0-ffb2b605d405
countsraw = map(tkn -> tkn.passage.text, lex) |> countmap |> OrderedDict

# ╔═╡ 031f5326-1be6-45e5-9c93-12052fd2d38a
counts = sort(countsraw, byvalue = true, rev = true)

# ╔═╡ dbc4719c-cb6f-43c3-ac3f-fa3f916518aa
distincttokens = length(counts)

# ╔═╡ 00f8a440-8774-4b4e-88ad-ff812fa02100
...
# ╔═╡ 1f738e4e-7528-4758-b904-b1d80b044cfd
md"""## Lemmatized frequencies"""
...
# ╔═╡ d7af61fa-f0d4-4795-9b04-23261aa5ae41
...
# ╔═╡ 4cd39e61-d6d3-4a94-a919-84ef409d77b8
md"""## Plots"""

# ╔═╡ 95fb665e-74e3-4531-bf82-4f7bc8b48bd6
xs = collect(keys(runningtotaldict))

# ╔═╡ 0e366d6a-4345-4491-8d87-b1a30a5772bc
ys = collect(values(runningtotaldict))

# ╔═╡ 06622713-f616-435f-ac57-3a11ff4d9feb
pctys = collect(values(runningtotalpct))

# ╔═╡ 186a4fea-7244-4945-84aa-decfa973e493
begin
	fig1 = Figure()
	ax1 = Axis(fig1[2, 1],
...
# ╔═╡ 3cbe0dda-184c-435d-a836-1fae99928e11
1:length(ys)
...
manifest_format = "2.0"
project_hash = "6111f83f6f849e160ee2d40364c708390204d269"
